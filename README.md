...
### 1. [Anomaly Detection in Education using Deep Auto Encoder](https://github.com/ishuu9837)
...
- Achieved **~90% Accuracy**, **100% Recall**, and **99.4% ROC-AUC** — zero false negatives on abnormal patterns.
...
### 2. [Heart Disease Prediction using Autoencoders](https://github.com/ishuu9837)
...
### 3. [Image Colourisation using Auto Encoders](https://github.com/ishuu9837)
**Role**: Deep Learning Engineer | 📅 *2025*
...
### 4. [I⚡H — Intelligent Movie Recommender using Letterboxd](https://github.com/ishuu9837)
...
- **⚡ Fun Fact:**
  - Fascinated by space exploration 🌌 and love to automate just about anything using Python!
